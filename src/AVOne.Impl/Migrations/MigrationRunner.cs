...
namespace AVOne.Impl.Migrations
{
    ...
    public sealed class MigrationRunner
    {
        ...
        public static void Run(ApplicationAppHost host, ILoggerFactory loggerFactory)
        {
        ...
        /// <param name="loggerFactory">Factory for making the logger.</param>
        internal static void RunPreStartup(IApplicationPaths appPaths, ILoggerFactory loggerFactory)
        {
            var logger = loggerFactory.CreateLogger<MigrationRunner>();
            ...
            var serverConfig = File.Exists(appPaths.SystemConfigurationFilePath)
                ? (ApplicationConfiguration)xmlSerializer.DeserializeFromFile(typeof(ApplicationConfiguration), appPaths.SystemConfigurationFilePath)!
