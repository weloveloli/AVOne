...
namespace AVOne.Plugins.MetaTube
{
    ...
    using AVOne.Plugins.MetaTube.Models;
    using Microsoft.Extensions.Logging;

    public class MetatubeApiClient
    {
        private readonly HttpClient _httpClient;
        private readonly ILogger<MetatubeApiClient> _logger;

        private MetaTubeConfiguration _metaTubeConfiguration => Plugin.Instance.Configuration;
        public MetatubeApiClient(HttpClient httpClient, ILogger<MetatubeApiClient> logger)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            this._logger.LogDebug("Requesting data from {url}.", url);
            var request = new HttpRequestMessage(HttpMethod.Get, url);
