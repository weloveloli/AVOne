...
namespace AVOne.Tools.Migrations
{
    ...
    public sealed class MigrationRunner
    {
        ...
        internal static void Run(ConsoleAppHost host, ILoggerFactory loggerFactory)
        {
        ...
        internal static void RunPreStartup(IApplicationPaths appPaths, ILoggerFactory loggerFactory)
        {
            ...
            var serverConfig = File.Exists(appPaths.SystemConfigurationFilePath)
                ? (ConsoleConfiguration)xmlSerializer.DeserializeFromFile(typeof(ConsoleConfiguration), appPaths.SystemConfigurationFilePath)!
